package com.dgg.qualification.jpush;
    ...
    public void onReceive(Context context, Intent intent) {
        try {
            ...
            if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
                ...
                LogUtils.d(TAG, " 自定义信息值--------- " + msg);
                if (msg.contains("80006"))
                    EventBus.getDefault().post("80006", MainActivity.APP_EXIT);
