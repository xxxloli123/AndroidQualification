...
//    private static HiPermission mInstance;
    ...
    public void checkSinglePermission(String permission, PermissionCallback callback) {
        ...
        mCallback = callback;
        mPermissionType = PermissionDialogActivity.PERMISSION_TYPE_SINGLE;
        mCheckPermissions = new ArrayList<>();
    ...
    private void startActivity() {
        PermissionDialogActivity.setCallBack(mCallback);
        Intent intent = new Intent(mContext, PermissionDialogActivity.class);
