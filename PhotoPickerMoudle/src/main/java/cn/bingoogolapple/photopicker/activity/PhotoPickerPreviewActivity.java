 ...
 * 描述:图片选择预览界面
 */
public class PhotoPickerPreviewActivity extends APPToolbarActivity implements PhotoViewAttacher.OnViewTapListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.tv_photo_picker_preview_submit) {
            ...
            if (mSelectedImages.contains(currentImage)) {
                ...
                mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.btn_normal, 0, 0, 0);
                renderTopRightBtn();
            } else {
                if (mMaxChooseCount == 1) {
                    // 单选
                    ...
                    mChooseTv.setCompoundDrawablesWithIntrinsicBounds(R.mipmap.btn_selected, 0, 0, 0);
                    renderTopRightBtn();
                } else {
                    // 多选
