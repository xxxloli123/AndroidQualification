...
public class PhotoPickerActivity extends APPToolbarActivity implements OnItemChildClickListener, BaseAsyncTask.Callback<ArrayList<ImageFolderModel>> {
    ...
    public static Intent newIntent(Context context, File imageDir, int maxChooseCount, ArrayList<String> selectedImages, boolean pauseOnScroll) {
        ...
        intent.putExtra(EXTRA_MAX_CHOOSE_COUNT, maxChooseCount);//> 5 ? 5 : maxChooseCount
    ...
    public static ArrayList<String> getSelectedImages(Intent intent) {
        ArrayList<String> paths = intent.getStringArrayListExtra(EXTRA_SELECTED_IMAGES);

        return paths == null ? new ArrayList<String>() : paths;
    }
    ...
    public void onClick(View v) {
        if ((v.getId() == R.id.tv_photo_picker_title || v.getId() == R.id.iv_photo_picker_arrow) &&
                mImageFolderModels != null && mImageFolderModels.size() > 0 && System.currentTimeMillis() - mLastShowPhotoFolderTime > PhotoFolderPw.ANIM_DURATION) {
            showPhotoFolderPw();
