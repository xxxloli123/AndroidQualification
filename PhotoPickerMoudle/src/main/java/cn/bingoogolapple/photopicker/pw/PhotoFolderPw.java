 ...
 */
public class PhotoFolderPw extends BasePopupWindow implements OnRVItemClickListener {
     ...
     * @param datas
     */
    public void setData(ArrayList<ImageFolderModel> datas) {
    ...
    private class FolderAdapter extends BaseRecyclerAdapter<ImageFolderModel> {
        ...
        public FolderAdapter(RecyclerView recyclerView) {
            ...
            mData = new ArrayList<>();
            mImageWidth = PhotoPickerUtil.getScreenWidth(mActivity) / 10;
            mImageHeight = mImageWidth;
        }

        @Override
        protected void fillData(BaseHelper helper, int position, ImageFolderModel model) {
