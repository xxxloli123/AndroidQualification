package cn.bingoogolapple.photopicker.helper;
 ...
 */
public class BaseHelper implements View.OnClickListener, View.OnLongClickListener, CompoundButton.OnCheckedChangeListener{
    protected final SparseArray<View> mViews;
    protected View mConvertView;
    protected Context mContext;
    protected int mPosition;
    protected BaseRecyclerHolder mRecyclerViewHolder;
    ...
    public BaseHelper(ViewGroup adapterView, View convertView) {
    ...
    public BaseHelper(RecyclerView recyclerView, View convertView) {
        mViews = new SparseArray<>();
    ...
    public void setRecyclerViewHolder(BaseRecyclerHolder recyclerViewHolder) {
        mRecyclerViewHolder = recyclerViewHolder;
    }

    public BaseRecyclerHolder getRecyclerViewHolder() {
     ...
     * @return
     */
    public BaseHelper setText(@IdRes int viewId, CharSequence text) {
     ...
     * @return
     */
    public BaseHelper setText(@IdRes int viewId, @StringRes int stringResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setHtml(@IdRes int viewId, String source) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setChecked(@IdRes int viewId, boolean checked) {
        Checkable view = getView(viewId);
        view.setChecked(checked);
        return this;
    }

    public BaseHelper setTag(@IdRes int viewId, Object tag) {
        View view = getView(viewId);
        view.setTag(tag);
        return this;
    }

    public BaseHelper setTag(@IdRes int viewId, int key, Object tag) {
        View view = getView(viewId);
        view.setTag(key, tag);
        return this;
    }

    public BaseHelper setVisibility(@IdRes int viewId, int visibility) {
        View view = getView(viewId);
        view.setVisibility(visibility);
        return this;
    }

    public BaseHelper setImageBitmap(@IdRes int viewId, Bitmap bitmap) {
        ImageView view = getView(viewId);
        view.setImageBitmap(bitmap);
        return this;
    }

    public BaseHelper setImageDrawable(@IdRes int viewId, Drawable drawable) {
        ImageView view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setTextColorRes(@IdRes int viewId, @ColorRes int textColorResId) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setTextColor(@IdRes int viewId, int textColor) {
        TextView view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setBackgroundRes(@IdRes int viewId, int backgroundResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setBackgroundColor(@IdRes int viewId, int color) {
        View view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setBackgroundColorRes(@IdRes int viewId, @ColorRes int colorResId) {
        View view = getView(viewId);
     ...
     * @return
     */
    public BaseHelper setImageResource(@IdRes int viewId, @DrawableRes int imageResId) {
        ImageView view = getView(viewId);
