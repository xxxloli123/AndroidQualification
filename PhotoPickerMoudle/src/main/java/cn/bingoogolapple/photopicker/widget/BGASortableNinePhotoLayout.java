...
import cn.bingoogolapple.photopicker.adapter.BaseRecyclerAdapter;
...
public class BGASortableNinePhotoLayout extends RecyclerView implements OnItemChildClickListener, OnRVItemClickListener {
    ...
    public BGASortableNinePhotoLayout(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        addItemDecoration(new SpaceItemDecoration(getResources().getDimensionPixelSize(R.dimen.bga_pp_size_photo_divider)));
...
//        int itemWidth = PhotoPickerUtil.getScreenWidth(getContext()) / (mItemSpanCount + 1);
        int itemWidth = AutoUtils.getPercentWidthSize(220);
        int width = itemWidth * mGridLayoutManager.getSpanCount() + ((AutoUtils.getPercentWidthSize(20)) * (mGridLayoutManager.getSpanCount() - 1));
        int height = 0;
    ...
    private class PhotoAdapter extends BaseRecyclerAdapter<String> {
        ...
        @Override
        protected void setItemChildListener(BaseHelper helper) {
    ...
    private class ItemTouchHelperCallback extends ItemTouchHelper.Callback {
        ...
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
                ...
                ((BaseRecyclerHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(getResources().getColor(R.color.bga_pp_photo_selected_mask));
            }
        ...
        public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            ...
            ((BaseRecyclerHolder) viewHolder).getViewHolderHelper().getImageView(R.id.iv_item_nine_photo_photo).setColorFilter(null);
