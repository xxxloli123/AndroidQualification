...
public class WaveFrameLayout extends FrameLayout {
    ...
    public WaveFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void init() {
        ...
        bgDrawable = getResources().getDrawable(R.mipmap.tiku_daohanglan_bg);
